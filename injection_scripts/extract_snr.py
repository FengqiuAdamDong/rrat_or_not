...
if __name__=='__main__':
    ...
    parser.add_argument("-dm", default = 0, help="dm to dedisperse to, if not given, will use positive burst file")
    parser.add_argument('-o', default='detection_statistics', help='output file name', required=True)
    ...
    for p in positive_fl:
        ...
        if len(fil1)==0:
            ...
            fil1,dm1,toa1 = combine_positives(fil1,fil_temp,dm1,dm_temp,toa1,toa_temp)
