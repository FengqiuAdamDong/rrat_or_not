...
class dynesty_plot:
    ...
    def plot_accuracy_logn(self):
        ...
        plt.plot(x, x, "r--")
        plt.xlabel(r"True $\mu_s$")
        plt.ylabel(r"recovered $\mu_s$")
        plt.title(f"{self.dets} detections true $\sigma_s$ = {true_sigmas[0]}")
        ...
        # plt.plot(x,x,'r--')
        plt.xlabel(r"index")
        plt.ylabel(r"recovered $\sigma_s$/True $\sigma_s$")
        plt.title(f"{self.dets} detections true $\sigma_s$ = {true_sigmas[0]}")
