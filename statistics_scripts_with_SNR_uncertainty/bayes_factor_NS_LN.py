...
if __name__ == "__main__":
    ...
    for real_det,config_det in zip(dill_files,config_files):
        ...
        def loglikelihood(theta, det_snr, xlim_interp):
            ...
            X = {"mu": LN_mu, "std": LN_std, "N": theta[2], "a":theta[3], "lower_c":lower_c, "upper_c":upper_c}
            return statistics.total_p(X, snr_arr = det_snr, use_a=True,use_cutoff=True,xlim=xlim,cuda_device=0)
