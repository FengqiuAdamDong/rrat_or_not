...
if __name__ == "__main__":
    ...
    fluence = fake_pulsar_params[:,1]

    #create an array that is
    maskfn = fil.strip(".fil") + "_rfifind.mask"

    detection_obj = det_obj(fluence = fluence,width=width,toas=toas,
